...
bool ArenaTile::Initialise(DX10_Renderer* _pDX10_Renderer, DX10_Mesh* _pMesh, DX10_Shader_LitTex* _pShader, eBaseTileImages _baseImage)
{
	...
	switch (_baseImage)
	{
		case BTI_SLIPPERY:
		{
			DX10_Obj_LitTex::Initialise(_pDX10_Renderer, _pMesh, _pShader, "Tron/Tile/tron_tile_blue.png");
		}
		break;
		case BTI_ROUGH:
		{
			DX10_Obj_LitTex::Initialise(_pDX10_Renderer, _pMesh, _pShader, "Tron/Tile/tron_tile_red.png");
		}
		break;
		case BTI_STANDARD:	// Fall Through
		default:
		{
			DX10_Obj_LitTex::Initialise(_pDX10_Renderer, _pMesh, _pShader, "Tron/Tile/tron_tile_white.png");
		}
	}	// End Switch
...
void ArenaTile::Render()
{
	if (m_active == true)
	{
		...
		_litTex.pTexBase = (*m_pTextures)[0];
...
{ 
	...
	case BTI_SLIPPERY:
	{
		VALIDATE(m_pRenderer->CreateTexture("Tron/Tile/tron_tile_blue.png", (*m_pTextures)[0]));
	}
		break;
	case BTI_ROUGH:
	{
		VALIDATE(m_pRenderer->CreateTexture("Tron/Tile/tron_tile_red.png", (*m_pTextures)[0]));
	}
		break;
	case BTI_STANDARD:	// Fall Through
	default:
	{
		VALIDATE(m_pRenderer->CreateTexture("Tron/Tile/tron_tile_white.png", (*m_pTextures)[0]));
	}
	}	// End Switch
